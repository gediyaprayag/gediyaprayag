...
- 💼 8 years building high-quality iOS & cross-platform apps
- 🧠 Strong in Swift, SwiftUI, UIKit, Combine, AVFoundation
- 📱 Building apps using React Native (Expo) for iOS & Android
- 🛠️ Backend with Node.js, Express, Supabase, Prisma, Firebase
- 🤖 AI integrations: GPT-4o, Replicate, Sora, Vision models
- 🌟 Focused on clean UI, user experience, and performance
